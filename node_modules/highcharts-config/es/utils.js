...
import { getOr, remove, set } from 'unchanged';
 ...
 */
export var isUndefined = function isUndefined(object) {
 ...
 */
export var assignFallback = function assignFallback(target) {
...
export var assign = typeof Object.assign === 'function' ? Object.assign : assignFallback;
 ...
 */
export var createAddMethod = function createAddMethod(Constructor, buildConfig) {
 ...
 */
export var createAddMethodWrapper = function createAddMethodWrapper(Constructor, method) {
  return function () {
 ...
 */
export var createBuildConfig = function createBuildConfig(Constructor) {
  return function () {
 ...
 */
export var getArrayOfItem = function getArrayOfItem(item) {
 ...
 */
export var getPathArray = function getPathArray(path) {
 ...
 */
export var getConfig = function getConfig(Config, config) {
 ...
 */
export var getDefaultSeries = function getDefaultSeries(config) {
  return getOr([], ['series'], config);
};
 ...
 */
export var getNamespacedKey = function getNamespacedKey(key, namespace) {
 ...
 */
export var canCombineChartTypes = function canCombineChartTypes(series) {
 ...
 */
export var createPropertyConvenienceMethod = function createPropertyConvenienceMethod(property) {
 ...
 */
export var isMixedChartType = function isMixedChartType(series) {
  if (!series.length) {
    return false;
  }
...
export var getFirstIfOnly = function getFirstIfOnly(items) {
 ...
 * @returns {Array<T>}
 */
export var getMatchingChartIndices = function getMatchingChartIndices(series, chart) {
 ...
 */
export var getNewChartSeries = function getNewChartSeries(series, type) {
 ...
 */
export var getNewConfigFromObject = function getNewConfigFromObject(currentConfig, object) {
 ...
 * @returns {Object} new configuration object
 */
export var getNewConfigWithSeries = function getNewConfigWithSeries(config, series) {
 ...
 */
export var getSpecificSeries = function getSpecificSeries(series, types) {
  var chart = void 0,
      indexOfChart = void 0,
      matches = void 0,
      match = void 0;
 ...
 */
export var removeOrOmit = function removeOrOmit(paths, object) {
  return paths.reduce(function (updatedObject, path) {
    return remove(path, updatedObject);
  }, object);
};